...
import Section_9Footer from './Section_9Footer';
import Section_3Gallery from './Section_3Gallery';
import Section_1Hotel from './Section_1Hotel';
import ButtonSeeMore from './assets/ButtonSeeMore';
...
export const _hotel: FC<Props> = memo(function continent(props = {}) {
  return (
