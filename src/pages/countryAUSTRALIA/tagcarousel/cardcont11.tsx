...
export default function CardCont_11() {
  return (
    <div className={styles.CardContinent_11_10_1175}>
      <div className={styles.CardBackground_110_1176}><img src={pic} alt="pic" width="605" height="389" style={{
    height: 389,
    width: '100%',
    marginLeft: 'auto',
    marginRight: 'auto',
