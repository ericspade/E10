...
export default function CardCont_3() {
  return (
    <div className={styles.CardContinent_3_10_1175}>
      <div className={styles.CardBackground_30_1176}><img src={pic} alt="pic" width="616" height="757" style={{
    height: 757,
    width: '100%',
    marginLeft: 'auto',
    marginRight: 'auto',
