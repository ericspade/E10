...
export default function CardCont_4() {
  return (
    <div className={styles.CardContinent_4_10_1175}>
      <div className={styles.CardBackground_40_1176}><img src={pic} alt="pic" width="605" height="389" style={{
    height: 389,
    width: '100%',
    marginLeft: 'auto',
    marginRight: 'auto',
