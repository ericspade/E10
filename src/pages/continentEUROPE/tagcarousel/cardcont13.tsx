...
export default function CardCont_13() {
  return (
    <div className={styles.CardContinent_13_10_1175}>
      <div className={styles.CardBackground_130_1176}><img src={pic} alt="pic" width="463" height="280" style={{
    height: 280,
    width: '100%',
    marginLeft: 'auto',
    marginRight: 'auto',
