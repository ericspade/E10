...
export default function CardCont_5() {
  return (
    <div className={styles.CardContinent_5_10_1175}>
      <div className={styles.CardBackground_50_1176}><img src={pic} alt="pic" width="458" height="585" style={{
    height: 585,
    width: '100%',
    marginLeft: 'auto',
    marginRight: 'auto',
