...
import Section_1TourWelcome from './Section_1TourWelcome';
...
import Section_4Title2 from './Section_4Title2';
import Section_4Title3 from './Section_4Title3';
...
export const _tour: FC<Props> = memo(function continent(props = {}) {
  return (
