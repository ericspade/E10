...
export interface ICardDestswitzerlandProps {
  className?: string;
}

export const CardDestswitzerland = ({
  className,
  ...props
}: ICardDestswitzerlandProps): JSX.Element => {
  return (
    <div className={styles.c1 + " " + className}>
      ...
      <div className={styles.photoName}>
        ...
        <div className={styles.country}>Switzerland </div>
      </div>
    </div>
  );
};